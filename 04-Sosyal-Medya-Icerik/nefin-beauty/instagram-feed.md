...
grid_ratio: "4:5"
theme: dark
highlights: ["Rutin", "Ürünler", "SSS"]
status_bar_time: "19:28"
status: draft
date: 2026-09-21
tags: [sosyal-medya, instagram, onizleme]
related: ["[[00-Musteriler/nefin-beauty/marka-brief]]"]
---

# Nefin Beauty — Instagram Feed Önizlemesi

> Bu not `scripts/instagram-studio.js` tarafından yazılır. Gönderi sırası = ızgara sırası (en yeni üstte). Gönderiler bölümü dışındaki bölümler korunur.
> Müşteriye gönderilecek dosya: `node scripts/build-instagram.js nefin-beauty`
